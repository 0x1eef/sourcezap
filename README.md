...
sourcezap manages a local copy of the BSD source tree. It provides
consistent ownership and permissions for the source tree, keeps a
...
Run as root **or** as a member of the `_sourcezap` group. <br>
